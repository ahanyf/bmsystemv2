...
-->
<!-- Modal -->
<div class="modal fade" id="m-vi_payment_edit" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xxxsm" role="document">
    <div class="modal-content">
      <form method="post" action="app/bm_pettycash/model_invoice_payment_edit_post.php">
        ...
        <div class="modal-body m-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="payment_amount" step="any" class="form-control" placeholder="Amount"
                value="<?php echo htmlspecialchars( $payment_invoice_[$id]['paid_amounte'] ); ?>" required>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Payment Date:</label>
              <input type="date" value="<?php echo $payment_invoice_[$id]['paid_date']; ?>" name="payment_date" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select name="payment_method" class="form-control" required>
              	...
              	<option value="<?php echo $payment_invoice_[$id]['payment_method']; ?>"><?php echo $payment_invoice_[$id]['payment_method']; ?></option>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" value="<?php echo $payment_invoice_[$id]['payer_name']; ?>" name="payer_name" class="form-control" placeholder="Name of the Person" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <input type="text"  value="<?php echo $payment_invoice_[$id]['remarks']; ?>"   name="remarks" class="form-control" placeholder="Enter Payment Remarks" required>
            </div>
          </div>
        </div>
