...
$filename =  'PI' . htmlspecialchars($pr_[$id]['pr_year']) . '_' . htmlspecialchars($pr_[$id]['pr_ref']);


  header("Content-Type: application/vnd.ms-excel");
    header("Content-Disposition: attachment; filename=Payment_Request_".$filename.".xls");
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <!-- Ref No -->
          <td><?php echo htmlspecialchars($invoice['vi_ref']); ?></td>
			
          <!-- Date -->
        <td>   <?php echo htmlspecialchars($invoice['vi_date']); ?></td>
        
        
        <td><!-- GST -->
        	<?php
        	 		echo number_format($invoice['vi_gst'], 2);
        	?>
