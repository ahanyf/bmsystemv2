...
<div class="modal fade" id="m-gas-reg-delete" tabindex="-1" role="dialog" aria-labelledby="deleteRegistryLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form method="post" action="app/bm_gas/check_model_form_delete_post.php">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteRegistryLabel">Delete Registry</h5>
                ...
                <div class="modal-body m-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <h3>Do you want to delete the registration?</h3>
                        </div>
                        <div class="col-md-7">
