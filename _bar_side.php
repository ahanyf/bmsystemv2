				...
				<div class="sidebar-user">
					<div class="d-flex justify-content-center">
						<div class="flex-shrink-0">
							<img src="_AdminKitPro/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" />
						</div>
...
-->
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="?app=reorder&page=list">
							<i class="align-middle" data-feather="list"></i> <span class="align-middle">Reorder List</span>
						</a>
					</li>
